...
SWIFT_CLASS("_TtC5Keyri5Event") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
- (void)initiateQrSessionWithPublicUserId:(NSString * _Nullable)publicUserId sessionId:(NSString * _Nonnull)sessionId appKey:(NSString * _Nonnull)appKey completion:(void (^ _Nonnull)(Session * _Nullable, NSError * _Nullable))completion;
...
- (NSString * _Nullable)generateAssociationKeyWithPublicUserId:(NSString * _Nullable)publicUserId error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)generateUserSignatureWithPublicUserId:(NSString * _Nullable)publicUserId data:(NSData * _Nonnull)data error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
